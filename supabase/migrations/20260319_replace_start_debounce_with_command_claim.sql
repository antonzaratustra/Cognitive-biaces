-- Replaces the old cb_events-based /start debounce with an atomic claim table.
-- The first parallel request claims processing; duplicates within the debounce window
-- are ignored without sending a second Telegram message.
